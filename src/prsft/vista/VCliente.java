...
import prsft.controlador.ControladorCliente;
...
public class VCliente extends javax.swing.JFrame {
    ...
    public VCliente() throws InstantiationException, IllegalAccessException {
...
// metodo para limpiar 
  ...
  // metodo para llenar la tabla 
    ...
    private void tbclienteMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tbclienteMouseClicked
        ...
        // condicion para 
        if(fila>=0){
           txtId.setText(tbcliente.getValueAt(fila, 0).toString());
           txtNombre.setText(tbcliente.getValueAt(fila, 1).toString());
           txtDireccion.setText(tbcliente.getValueAt(fila, 3).toString());
           txtTelefono.setText(tbcliente.getValueAt(fila, 2).toString());
           txtMail.setText(tbcliente.getValueAt(fila, 4).toString());
    ...
    private void formWindowClosing(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_formWindowClosing
        ControladorCliente.visible = false;
        System.err.println(ControladorCliente.visible);
